  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Revenue, sales trends, and inventory reports"
      />
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-white/8">
                {['Month', 'Revenue', 'Expenses', 'Profit', 'Margin'].map(
                  (h) => (
                    <th
                      key={h}
                      className="text-left text-xs font-medium text-white/35 uppercase tracking-wider px-3 py-2.5"
                    >
                      {h}
                    </th>
                  )
            ...
            <tbody>
              {REVENUE_DATA.map((r) => (
                ...
                >
                  <td className="px-3 py-3 text-white/70 font-medium">
                    {r.month}
                  </td>
                  <td className="px-3 py-3 text-white/70">
                    ${r.revenue.toLocaleString()}
                  </td>
                  <td className="px-3 py-3 text-rose-400/80">
                    ${r.expenses.toLocaleString()}
                  </td>
                  <td className="px-3 py-3 text-emerald-400">
                    ${r.profit.toLocaleString()}
                  </td>
                  <td className="px-3 py-3 text-indigo-300">
