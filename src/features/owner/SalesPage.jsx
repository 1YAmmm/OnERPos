...
import { SalesSkeleton } from '../../components/common/Skeleton';
...
export function SalesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Sales"
        subtitle="Transaction history and revenue overview"
      />
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <GlassCard key={s.label} delay={i * 0.08} className="p-4">
            ...
            <p
              className={`text-xl font-bold ${s.warn ? 'text-rose-400' : 'text-white/85'}`}
            >
              {s.value}
            </p>
